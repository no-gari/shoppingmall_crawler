...
#     code = models.IntegerField(verbose_name="등록 상품")
#     name = models.CharField(max_length= 255, verbose_name="등록 상품")
#
#     class Meta:
#         verbose_name = '등록상품'
#         verbose_name_plural = '등록상품'
...
class Comment(models.Model):
    text = models.TextField(verbose_name='답변 내용')
    date = models.DateTimeField(verbose_name='등록 시간')
